...
export default function SurveyForm() {
  ...
  return (
    <div style={{ width: "285px", marginLeft: "28px", fontFamily: "system-ui" }}>
      ...
      <textarea id="description" name="description" placeholder="Descrição" rows="4" cols="50" style={{ width: "100%" }} value={survey.description} onChange={(e) => setSurvey({ ...survey, description: e.target.value })} /><br />
