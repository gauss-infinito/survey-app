...
export default function SurveyForm() {
  ...
  return (
    <div className="w-285 ml-lg font-system">
      ...
      <textarea id="description" name="description" placeholder="Descrição" rows="4" className="w-full font-system" value={survey.description} onChange={(e) => setSurvey({ ...survey, description: e.target.value })} /><br />
