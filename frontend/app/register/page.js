  ...
  return (
    <div style={{ width: "177px" }}>
      ...
      <div style={{ marginTop: "10px" }}>
        ...
        <input id="age1" name="age" type="radio" value="jovem" onChange={(e) => setAge(e.target.value)} /> Jovem: 18 a 20 anos<br />
        <input id="age2" name="age" type="radio" value="adulto" onChange={(e) => setAge(e.target.value)} /> Adulto: 21 a 59 anos<br />
        <input id="age3" name="age" type="radio" value="idoso" onChange={(e) => setAge(e.target.value)} /> Idoso: 60 anos ou mais<br />
      </div>
